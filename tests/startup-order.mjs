...
assert.deepEqual(registeredPackBatches[0].packs.map((pack) => pack.cards.length), [30, 30, 10]);
...
console.log("PF2E Critical Forge: Arcane Backlash 0.3.0 startup-order validation passed.");
