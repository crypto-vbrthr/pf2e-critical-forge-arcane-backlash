...
assert.deepEqual(registeredPackBatches[0].packs.map((pack) => pack.cards.length), [30, 30, 30, 30]);
...
console.log("PF2E Critical Forge: Arcane Backlash 0.4.3 startup-order validation passed.");
